...
\end{example}
Il partizionamento risulta interessante per l'ambito trattato in questo lavoro quando vi si aggiunge la seguente restrizione sui blocchi:
\begin{definition}
...
\begin{observation}
    Sia $P$ una partizione qualsiasi di un insieme $U$, e siano $S,T \subseteq U$. Sia $f: U \to U$. Supponiamo $P$ stabile rispetto alle coppie $(f,S),(f,T)$. Allora:
    \begin{enumerate}
