...
\begin{theorem}
    Sia $A$ un'automa a stati finiti. Supponiamo che in tale automa uno stato finale ed uno non finale non possa essere assegnato un output identico. La minimizzazione per stati equivalenti dell'automa è l'automa avente per stati i blocchi della partizione più grossolana stabile rispetto alle funzioni $\delta_i : S \to S, \forall i \in I$.
\end{theorem}
\begin{proof2}
