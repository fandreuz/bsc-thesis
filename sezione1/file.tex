...
\begin{observation}
    ...
    Se $\widetilde{S}$ è stabile rispetto ad un insieme $A, \splitfunc(B,\widetilde{S})$ è stabile rispetto ad $A,B$. In altre parole la funzione ``\splitfunc'' preserva la stabilità.
\end{observation}
\begin{proof2}
