...
Finora abbiamo trattato solamente algoritmi che, a partire dal grafo e da una eventuale partizione iniziale, determinano la \rscpnomath (e quindi la bisimulazione massima). Se in seguito il grafo viene modificato, ad esempio con l'aggiunta di un arco, è necessario far ripartire l'algoritmo, in quanto è possibile che la \rscpnomath cambi. L'algoritmo di Saha, presentato in \cite{saha}, consente di ridurre drasticamente la complessità del ricalcolo della \rscpnomath, quando sono note la trasformazione del grafo (l'aggiunta di un arco) e la \rscpnomath prima della trasformazione. Come vedremo, l'algoritmo si basa sulla considerazione di diversi casi in cui sono necessarie operazioni differenti a seconda del rango delle SCC messe in relazione dal nuovo arco.
