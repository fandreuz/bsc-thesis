...
\end{definition}
% TODO: esempio
Sulla base di queste definizioni, introduciamo la seguente funzione, che ricopre un ruolo primario nell'Algoritmo BFA:
\begin{definition}
    ...
    \begin{gather*}
        \rankfunc(n) = \begin{cases}
            0 &\text{se $n$ è una foglia di $G$}\\
            -\infty &\text{se $[n]$ è un pozzo di $G^{\scalebox{.5}{SCC}}$, $n$ non è un pozzo di $G$}\\
            \max(\{1 + rank(m) \mid m \in \mathcal{N_{\scalebox{0.5}{WF}}}(n)\}\\
            \,\,\,\,\,\,\,\,\,\,\,\,\,\, \cup \,\, \{rank(m) \mid m \in \mathcal{N_{\scalebox{0.5}{NWF}}}(n)\}) &\text{altrimenti}
        \end{cases}
    \end{gather*}
\end{definition}
