...
\begin{algorithm}[H]
    ...
    \Begin{
        ...
        Split2($G, P, u, \bigcup_{i=0}^\rho B_i$)\;
...
In seguito, per ogni rango a partire dal rango 0, si considerano i blocchi di rango $i$ e si isola il sottografo contenenti solamente nodi composti dai nodi che vi sono contenuti. A questo punto si applica l'Algoritmo PTA a questo sottografo, e si ottiene la RSCP del sottografo. I blocchi di questa nuova partizione vengono ``collassati'', e poi si impone ai blocchi di rango superiore la condizione di stabilità.
