...
\begin{frame}\frametitle{Risultati sperimentali II}
    \begin{figure}
        ...
        \begin{subfigure}{0.49\textwidth}
            \centering
            Regola per la generazione degli archi:\\
            $\mathcal{P}(\langle a,b \rangle \in E) =$ \texttt{p}
        \end{subfigure}
    \end{figure}
\end{frame}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                ylabel={Secondi},
                xticklabels={,,},
                title={100 grafi binomiali, 5000 nodi, p=0.001}
            ]
            \addplot table[x=x,y=y] {../experiments/time/saha/random/scatter_3_0.txt};
            \addlegendentry{Paige-Tarjan}
            \addplot table[x=x,y=y] {../experiments/time/saha/random/scatter_3_2.txt};
            \addlegendentry{Saha}
        \end{axis}
        \end{tikzpicture}
    \end{figure}
