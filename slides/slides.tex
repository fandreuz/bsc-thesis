    ...
    \begin{figure}
        \begin{tikzpicture}
            ...
            \begin{scope}[on background layer]
                \fill[green,opacity=0.2] ({rel axis cs:0,0}) rectangle ({rel axis cs:0.04,1});
                \fill[cyan,opacity=0.2] ({rel axis cs:0.04,0}) rectangle ({rel axis cs:0.09,1});
                \fill[lightgray,opacity=0.2] ({rel axis cs:0.09,0}) rectangle ({rel axis cs:0.14,1});
                \fill[magenta,opacity=0.2] ({rel axis cs:0.14,0}) rectangle ({rel axis cs:0.26,1});
                \fill[lime,opacity=0.2] ({rel axis cs:0.26,0}) rectangle ({rel axis cs:0.68,1});
                \fill[orange,opacity=0.2] ({rel axis cs:0.68,0}) rectangle ({rel axis cs:0.81,1});
                \fill[pink,opacity=0.2] ({rel axis cs:0.81,0}) rectangle ({rel axis cs:0.89,1});
                \fill[teal,opacity=0.2] ({rel axis cs:0.89,0}) rectangle ({rel axis cs:0.92,1});
                \fill[teal,opacity=0.2] ({rel axis cs:0.92,0}) rectangle ({rel axis cs:1,1});
            \end{scope}
            \end{axis}
        \end{tikzpicture}
    \end{figure}
