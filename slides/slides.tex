...
\begin{frame}\frametitle{Massima bisimulazione -{}- {\normalsize Applicazioni pratiche}}
    \begin{figure}
        \begin{subfigure}{0.55\textwidth}
            \centering
            \begin{tikzpicture}[scale=0.5]
    ...
    \begin{figure}
        ...
        \begin{subfigure}{0.48\textwidth}
            \begin{tikzpicture}
                \begin{axis}[
                    axis on top,
                    width=\textwidth,
                    legend style={nodes={scale=0.7, transform shape}, fill=white,opacity=0.8, at={(0,0.76)},anchor=south west, legend columns=1},
                    legend cell align={left},
                    ytick style={draw=none},
                    xtick style={draw=none},
                    xlabel={Numero di nodi},
        ...
        \begin{subfigure}{0.48\textwidth}
            ...
            \begin{enumerate}
                ...
                \item \textbf{Aggiornamento} massima bisimulazione (con \emph{PT}, \emph{Saha}).
            \end{enumerate}
        \end{subfigure}
    \end{figure}
\end{frame}
