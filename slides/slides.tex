...
\newcommand{\bisimulation}{\begin{block}{Definizione: Bisimulazione $\mathcal{B} \subseteq V \times V$}
    \centering
    Se $(a,b) \in \mathcal{B}$, allora da $a$ è possibile spostarsi verso un nodo figlio di $a$ che sia in relazione con uno dei nodi figli di $b$, e viceversa.
\end{block}}
...
\begin{frame}\frametitle{Grafi orientati}
    ...
    \begin{block}{Definizione: Nodo figlio}
        Se $\langle a,b \rangle \in E \implies b$ è un nodo figlio di $a$.
    \end{block}
\end{frame}
